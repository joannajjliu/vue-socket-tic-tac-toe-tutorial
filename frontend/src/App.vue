<template>
  <div class="container">
    ...
    <h2 v-if="isTie">Game is a Tie</h2>
  ...
  methods: {
    ...
    calculateWinner() {
      ...
      for (let i = 0; i < WIN_CONDITIONS.length; i++) {
        let firstIdx = WIN_CONDITIONS[i][0]
        let secondIdx = WIN_CONDITIONS[i][1]
        let thirdIdx = WIN_CONDITIONS[i][2]

        if (
          this.content[firstIdx] !== '' &&
          this.content[firstIdx] === this.content[secondIdx] &&
          this.content[firstIdx] === this.content[thirdIdx]
        ) {
          this.isOver = true
          this.winner = this.content[firstIdx]
        }
      }
    },
